...
- .n[It Mainly comprises bacteria belonging to phylum Proteobacteria and to the Bacteroidetes, Firmicutes and Actinomycetes]
...
- For example, Albugo laibachii and Dioszegia spp. have been identified62 as highly interactive hubs in the phyllosphere of *A. thaliana*.
]
]

???

- .n[such as barley, rice, sugarcane, grapevine, citrus, soybean and A. thaliana]

- .n[(for example, Pseudomonas, Agrobacterium, Methylobacterium, Sphingomonas, Erwinia, Cladosporium, Coniothyrium, Resinicium and Fusarium)]
---
.content-box-grey[
La piante non possono più essere considerate come unità a se stanti, ma è richiesta una visione **olistica**.]
<br>
.content-box-grey[
Il microbiota ha un impatto sia sulla **crescita** che **sopravvivenza** della pianta, due concetti chiave della fitness della pianta]
<br>
.content-box-grey[
La fitness della pianta è quindi una conseguenza delle **caratteristiche della pianta e del suo microbiota**] 
...
- .n[Le piante ospitano una grande varietà di micro organismi sia sulla loro superficie che all'interno]

---
layout: false
class: clear

.center[.font200[Holobiont]]



???

A plant and the members
of its associated microbiota considered as a single entity; this represents the ‘unit of selection’ at which plant– microbiome interactions have probably co-evolved in order to maintain host functionality and fitness over ecological and even evolutionary timescales
---
layout: false
