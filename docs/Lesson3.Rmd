...
.pull-left[
.f400[**What is a VIRUS?**] `r anicon::cia("images/virus-3128.png", animate="pulse", speed="slow")`
.m0tp[
.par30[

- A virus is a submicroscopic infectious agent that replicates only inside the living cells of an organism (obligate intracellular parasites)
